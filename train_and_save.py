...
def objective_fnn(trial):
    ...
    batch_size = 1024  # Add batch size hyperparameter
...
train_loader = DataLoader(fnn_dataset, batch_size=32, shuffle=True, pin_memory=False, num_workers=0)
for epoch in range(500):
    fnn_model.train()
    total_loss = 0
    for X_batch, y_batch in train_loader:
...
train_loader = DataLoader(tab_dataset, batch_size=32, shuffle=True, pin_memory=False, num_workers=0)
